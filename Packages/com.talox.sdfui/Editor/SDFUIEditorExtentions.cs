...
public class SDFUIEditorExtentions : MonoBehaviour
{

    private const string kUILayerName = "Interactive";

    [MenuItem("GameObject/UI/SDF UI Image")]
    private static void CreateSDFUI(MenuCommand menuCommand)
    {
        GameObject go = new GameObject("SDF UI Image");
        
        go.AddComponent<UISDFImage>();
