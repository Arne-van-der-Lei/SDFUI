    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.data = float4(v.texcoord1.xy,1,1);
                OUT.data2 = v.texcoord2;
            ...
            float opOnion( in float2 p, in float2 b, in float4 r ,in float ra)
            {
                return abs(sdRoundedBox(p,b,r)+ra) - ra;
            }
